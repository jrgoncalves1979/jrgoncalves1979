...
async function loadPosts() { 
    ...
    /*
    TRECHO DA AULA PASSADA, AGORA SENDO FEITO COM ASYNC E AWAIT,COMO ACIMA.
...
Nas funções assíncronas, devemos ter duas palavras obrigatórias nelas, 
para identificá-las. Essas palavras seriam:
